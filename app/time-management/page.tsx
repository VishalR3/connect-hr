...
import { LeaveRequestTableContainer } from "./leave-request-table/leave-request-table-container";
...
export default function TimeManagementPage() {
  ...
  return (
    <div className="w-full p-4">
      ...
      <div className="mt-8 grid grid-cols-12 gap-4 max-h-96">
        <div className="col-span-8">
          <LeaveRequestTableContainer />
        </div>
